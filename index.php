...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>Cartas</b>Garantía</span>
    </a>
...
$(document).on('ready',function(){
        ...
        mostrarRegistros(usuario,nombre,seguro,fecha,estado,carta);
        ...
        $("#registrar").click(function() {
           ...
           //console.log(usuario);
            ...
            $("#resultado").html("<center><img class='img img-responsive' width='80%' src='includes/img/loading_google.gif' /> Registrando</center>");
                $.ajax({
                    type:       'POST',
                    dataType:   'html',
                    url:        'ModuloCarta/getLetter.php',
                    data:       {registrar_letter:'registrar_letter', usuario: usuario, nombre:nombre, seguro:seguro, fecha:fecha, estado: estado, carta:carta},
        ...
        function mostrarRegistros(usuario,nombre,seguro,fecha,estado,carta){
            $("#resultado").load("ModuloCarta/getLetter.php",{'action': 'MostrarComentarios',usuario: usuario, nombre:nombre, seguro:seguro, fecha:fecha, estado: estado, carta:carta});
        }
